  ...
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/productManager/create"
        ...
        <div class="mb-3">
          <label for="product-size" class="form-label">Size <span class="text-danger">*</span></label>
          <input type="number"
                 class="form-control
                  &lt;%&ndash;${not empty requestScope.violations.pagesViolations
                   ? 'is-invalid' : (not empty requestScope.product.size ? 'is-valid' : '')}"&ndash;%&gt;
                 id="product-size"
                 name="size"
                 value="${requestScope.product.size}"
                 min="1"
                 required>
