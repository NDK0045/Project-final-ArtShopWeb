package com.artshopweb.servlet.admin.product;
...
import com.artshopweb.utils.ImageUtils;
import com.artshopweb.utils.Protector;
import com.artshopweb.utils.Validator;
...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        product.setSize(request.getParameter("pages"));
        ...
        violations.put("authorViolations", Validator.of(product.getAuthor())
                ...
                .isAtMostOfLength(50)
                .toList());
        violations.put("pagesViolations", Validator.of(product.getSize())
                .isNotNull()
                .isLargerThan(1, "Size")
                .toList());
                //.matches("\\d+\\s*x\\s*\\d+", "Size must be in the format 'number' x 'number'");
